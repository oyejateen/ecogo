      ...
      >
        ...
        <StyledView className="mb-8">
          <StyledView className="flex-row mb-6">
            ...
            >
              <StyledText className="text-center text-primary font-semibold">Login</StyledText>
            </StyledTouchableOpacity>
            <Link href="/(auth)/register" asChild>
              <StyledTouchableOpacity 
                className="flex-1 py-2 border-b-2 border-gray-200"
              >
                <StyledText className="text-center text-gray-400">Register</StyledText>
              </StyledTouchableOpacity>
            </Link>
          </StyledView>
          ...
          <StyledView className="flex-row items-center border border-gray-300 rounded-lg px-3 py-2 mb-1">
          ...
          <Link href="/(auth)/forgot-password" asChild>
            <StyledTouchableOpacity className="self-end mb-6">
              <StyledText className="text-primary text-sm">Forgot Password?</StyledText>
            </StyledTouchableOpacity>
          </Link>
          ...
          >
            {loading ? (
              ...
              <StyledText className="text-white text-center font-semibold">Login</StyledText>
            )}
          </StyledTouchableOpacity>
